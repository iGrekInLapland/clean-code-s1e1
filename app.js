...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className="input input_check item__input";
    //label
    ...
    editInput.type="text";
    editInput.className="input input_text item__input task";

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="btn btn_edit item__btn";

    deleteButton.className="btn btn_del item__btn";
...
//select ListItems children
    ...
    var deleteButton=taskListItem.querySelector("button.btn_del");
